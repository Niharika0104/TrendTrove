...
{loggedIn && (
   <button onClick={handleLogout} className="text-white border px-3 py-1 hover:text-blue-300">Logout</button>
  )}

<div>
      {!!user && (
        <div className='text-white border px-8 py-2 rounded-full'>
          {user.name}
        </div>
      )}
    </div>

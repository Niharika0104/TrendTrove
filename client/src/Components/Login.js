...
return(
  ...
  <form className='w-full mx-auto '>
    ...
    <div className="mt-9 sm:mt-4 md:mt-5 flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
      <input type="text" autoComplete="email" className="rounded-md flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-1 sm:text-sm sm:leading-6" placeholder="Email"/>
    </div>
    <div className="mt-6 md:mt-5 flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
      <input type="password" className="rounded-md flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Password"/>
    </div>
    ...
    <div className="md:mt-5 px-2 mt-6">
      <div className='text-center'>
       <span>Not a user?<a href='#' className='px-5 italic font-bold underline text-lightblue'>Register here</a></span>
      </div>
    </div>
  </form>
</div>
